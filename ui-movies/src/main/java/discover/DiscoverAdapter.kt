...
import com.example.ui_movies.databinding.DiscoverCardBinding

class DiscoverAdapter(
    private val tmdbImageUrlProvider: TmdbImageUrlProvider,
    private val onItemClickListener: (movieId: Int) -> Unit,
    private val onListResponse: (isEmpty: Boolean) -> Unit
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DiscoveryViewHolder {
        val binding = DiscoverCardBinding.inflate(
    ...
    override fun onBindViewHolder(holder: DiscoveryViewHolder, position: Int) {
        ...
        entry?.let { popularEntry ->
            ...
            holder.binding.subtitle.text =
                "${popularEntry.voteCount} votes \u00B7 ${popularEntry.releaseDate}"
...
class DiscoveryViewHolder(
    internal val binding: DiscoverCardBinding
